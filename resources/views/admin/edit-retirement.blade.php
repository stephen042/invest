                     ...
                     <div class="components-preview wide-md mx-auto">
                      <div class="nk-block-head nk-block-head-lg wide-sm">
                       <div class="nk-block-head-content">
                        ...
                        <h2 class="nk-block-title fw-normal">Edit  {{ $retirement->firstname }}</h2> Retirement Funds Deposit Request</h2>
                       </div>
                      </div><!-- .nk-block-head -->
                          ...
                          <div class="">
                           <form class="" method="POST" data-post-type="edit-plan" action="{{ route("admin.retirement.view",["edit",$retirement->id]) }}">
                            ...
                            <div class="col-sm-4 mt-3">
                             <div class="form-group">
                              <div class="form-control-wrap">
                               <button type="submit"  name="edit-plan" style="text-align:center;" class="d-block form-control btn btn-primary " >Edit Retirement Funds Deposit Record</button>
                              </div>
                             </div>
                            </div>
